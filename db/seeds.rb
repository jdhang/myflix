...
family_guy = Video.create({title: 'Family Guy', description: "This is a great funny show about a crazy family.", category: comedies})
futurama = Video.create({title: 'Futurama', description: "This is a funny show about the future!", category: comedies})
south_park = Video.create({title: 'South Park', description: "Hilarious show!!", category: comedies})
monk = Video.create({title: 'Monk', description: "This is a great show", category: dramas})
